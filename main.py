...
boot_line("JackTheMico ltd bios.js initializing", 1, delay=5)
print_dots_done(1)
...
boot_line("Jack Wenyoung ltd kernel.js initializing", 1)
print_dots_done(1)
...
t.gen_text("Welcome to JackTheMico's profile!", 9)
t.clone_frame(15)
t.clear_frame()

# Simulate login prompt
t.set_font("./font/OpenDyslexicNerdFontPropo-Regular.otf", 15)
t.gen_text(text="github login: ", row_num=1)
t.gen_typing_text(text="Jack Wenyoung", row_num=1, col_num=14, contin=True, speed=0.1)
t.clone_frame(10)
...
t.clear_frame()
t.gen_text(text="Welcome, Jack Wenyoung! Last Login: 01-01-1970T00:00:01", row_num=1)
t.set_prompt("\x1b[35mJackdoesstuff\x1b[39m@\x1b[32mgithub\x1b[39m:~$ ")
t.gen_prompt(2)
t.gen_typing_text(text="ghfetch -u lewisdoesstuff", row_num=2, contin=True, speed=0.1)

gh_stats = gifos.utils.fetch_github_stats("JackTheMico")
...
t.gen_prompt(26)
t.clone_frame(60)
t.gen_typing_text("reboot", row_num=19, contin=True, speed=0.1)
t.clone_frame(5)
t.clear_frame()
