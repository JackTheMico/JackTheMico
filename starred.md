...
- [kslstn/astro-i18n-blog-starter](https://github.com/kslstn/astro-i18n-blog-starter) - 
...
- [DreamMaoMao/maomaowm](https://github.com/DreamMaoMao/maomaowm) - wayland compositor with smooth animation
...
- [omkarcloud/gitpod-botasaurus](https://github.com/omkarcloud/gitpod-botasaurus) - Run Botasaurus in GitPod
...
- [luqmanishere/nvim-nixcats](https://github.com/luqmanishere/nvim-nixcats) - A Neovim configuration made with nixCats
...
- [siawkz/nvim-cheatsh](https://github.com/siawkz/nvim-cheatsh) - Seamless integration of cheat.sh with Neovim: Access a wide range of cheat sheets directly through Telescope.
- [Dan7h3x/LazyDo](https://github.com/Dan7h3x/LazyDo) - A little smart todo/task manager made for `neovim` enthusiasts.
...
- [nixith/nixOS-Config](https://github.com/nixith/nixOS-Config) - My nixOS configuration
...
- [catppuccin/hyprlock](https://github.com/catppuccin/hyprlock) - 🔒 Soothing pastel theme for Hyprlock
...
- [Kangaxx-0/first-zellij-plugin](https://github.com/Kangaxx-0/first-zellij-plugin) - 
...
- [ususdei/qute-keepassxc](https://github.com/ususdei/qute-keepassxc) - Qutebrowser userscript to fetch credentials from KeepassXC password database
...
- [thevickypedia/gmail-connector](https://github.com/thevickypedia/gmail-connector) - Python module to send SMS, emails and read emails.
...
- [faiyazahmad07/xss_vibes](https://github.com/faiyazahmad07/xss_vibes) - A modern tool written in Python that automates your xss findings.
- [shmilylty/OneForAll](https://github.com/shmilylty/OneForAll) - OneForAll是一款功能强大的子域收集工具
- [comfyanonymous/ComfyUI](https://github.com/comfyanonymous/ComfyUI) - The most powerful and modular diffusion model GUI, api and backend with a graph/nodes interface.
- [Mause/duckdb_engine](https://github.com/Mause/duckdb_engine) - SQLAlchemy driver for DuckDB
...
- [ljnsn/cz-conventional-gitmoji](https://github.com/ljnsn/cz-conventional-gitmoji) - A commitizen plugin that combines gitmoji and conventional commits.
...
- [ConlinH/aio-scrapy](https://github.com/ConlinH/aio-scrapy) - Implement scrapy with asyncio
...
- [backtrader2/backtrader](https://github.com/backtrader2/backtrader) - Python Backtesting library for trading strategies
...
- [bardia-heydari/postpython](https://github.com/bardia-heydari/postpython) - Postman collection runner library for python
...
- [dj95/zj-docker](https://github.com/dj95/zj-docker) - Zellij plugin to display docker containers and perform basic operations on them.
- [cristiand391/zj-quit](https://github.com/cristiand391/zj-quit) - A friendly `quit` plugin for zellij
- [vdbulcke/zellij-workspace](https://github.com/vdbulcke/zellij-workspace) - Zellij plugin for applying layouts to current zellij session
- [yaroslavborbat/zellij-bookmarks](https://github.com/yaroslavborbat/zellij-bookmarks) - Zellij plugin for creating, managing, and quickly inserting command bookmarks into the terminal.
...
- [demestoss/zellij-smart-sessionizer](https://github.com/demestoss/zellij-smart-sessionizer) - Instant Zellij session startup with layout selection capability
...
- [duduribeiro/devcontainer-features](https://github.com/duduribeiro/devcontainer-features) - 
...
- [arvinxx/power-yuque](https://github.com/arvinxx/power-yuque) - 语雀的增强插件
...
- [pimalaya/himalaya-vim](https://github.com/pimalaya/himalaya-vim) - Vim frontend for Himalaya CLI email client
